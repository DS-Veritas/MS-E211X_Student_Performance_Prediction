...
Maths <- Maths[-c(31:33)]        #remove G1,G3 and G3
View(Maths)
View(Result)
...
result_model <- glm(Result ~ failures + goout + sex + romantic, data = training_data, family = binomial)  #only significant variable used
